...
public class Anaramus implements ModInitializer {
    ...
    public static final Block POTION_CAULDRON = Registry.register(Registries.BLOCK, new Identifier(MODID,"potion_cauldron"), new PotionCauldron(FabricBlockSettings.copyOf(Blocks.CAULDRON)));
